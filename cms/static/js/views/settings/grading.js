define(['js/views/validation',
    ...
    // Need to insert new bars in right place.
            //GRADES: ['5', '4,5', '4', '3,5', '3'],	// defaults for new grade designators
            //descendingCutoffs: [{'designation':100,'cutoff':90},{'designation':90,'cutoff':80}, {'designation':80,'cutoff':70}, {'designation':70,'cutoff':60}],  // array of { designation : , cutoff : }
            GRADES: [],
            descendingCutoffs: [],
        ...
        // the labels showing the range e.g., 71-80
                ...
                this.$el.find('.range').each(function(i) {
                    var min = (i < cutoffs.length ? cutoffs[i].cutoff+1 : 0);
        ...
        // When a grade is removed, keep the remaining grades consistent.
                ...
                if (_this.descendingCutoffs.length === 1 && _this.descendingCutoffs[0].designation === _this.GRADES[0]) {
                    _this.descendingCutoffs[0].designation = 'Zaliczone';
        ...
        // If going from Pass/Fail to 3 levels, change to Pass to A
                if (gradeLength === 1 && this.descendingCutoffs[0].designation === 'Zaliczone') {
        ...
        // copy the boundary up to the next higher grade then remove
            ...
            failLabel: function() {
                if (this.descendingCutoffs.length === 1) return 'Niezaliczone';
                else return '2';
            },
