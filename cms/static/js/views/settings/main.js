define(['js/views/validation', 'codemirror', 'underscore', 'jquery', 'jquery.ui', 'js/utils/date_utils',
    ...
    // Model class is CMS.Models.Settings.CourseDetails
        ...
        // fill in fields
                   ...
                   this.$el.find('#course-difficulty').val(this.model.get('difficulty'));
                   this.$el.find('#course-course_category').val(this.model.get('course_category'));
                   this.$el.find('#course-timetable').val(this.model.get('timetable'));
                   this.$el.find('#course-organizer').val(this.model.get('organizer'));
