...
from lms.envs.common import (
    PRODUCTION, USE_TZ, TECH_SUPPORT_EMAIL, PLATFORM_NAME, PLATFORM_DESCRIPTION, BUGS_EMAIL, DOC_STORE_CONFIG, DATA_DIR,
...
################# Library Settings ###########################
LIBRARY_COPY_WITHOUT_OVERRIDING_FIELDS = True
