...
NAVOICA_SANDBOX = ENV_TOKENS.get("NAVOICA_SANDBOX", False)
NAVOICA_SANDBOX_URL = ENV_TOKENS.get("NAVOICA_SANDBOX_URL", '')
...
AWS_S3_HOST = AUTH_TOKENS.get("AWS_S3_HOST",None)
AWS_S3_ENDPOINT_URL = AUTH_TOKENS.get("AWS_S3_ENDPOINT_URL",None)
AWS_S3_REGION_NAME = AUTH_TOKENS.get("AWS_S3_REGION_NAME",None)
...
VIDEO_UPLOAD_PREAUTH_URL = ENV_TOKENS.get('VIDEO_UPLOAD_PREAUTH_URL', VIDEO_UPLOAD_PREAUTH_URL)
