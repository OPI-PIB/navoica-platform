...
copy-node-dist:  ## copies files generated by npm install inside studio container
    # run make static when it's done
	for f in node_modules/@edx/studio-frontend/dist/*; do docker cp $$f edx.devstack.studio:/edx/app/edxapp/edx-platform/node_modules/@edx/studio-frontend/dist/; done
