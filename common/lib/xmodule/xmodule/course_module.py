...
class CourseFields(object):
    ...
    advanced_modules = List(
        ...
        scope=Scope.settings,
        default=['survey', 'openassessment' ,'audioplayer']
    )
    has_children = True
    ...
    difficulty = String(
        ...
        help=_("Specify the difficulty of your course."),
        default=None,
        scope=Scope.settings
    )
    ...
    organizer = String(
        ...
        help=_("Specify the organizer of your course."),
        default=None,
        scope=Scope.settings
    )
    ...
    timetable = String(
        ...
        help=_("Specify the timetable of your course."),
        default=None,
        scope=Scope.settings
    )
